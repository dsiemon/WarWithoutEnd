...
public class GamePreferences extends BaseObject{
	...
	public GamePreferences(){
		...
		this.preferences[PreferenceType.MOB_SPEED.index()]   			= new Preference(0,0,0,true,0);
		this.preferences[PreferenceType.MOB_TECH.index()] 				= new Preference(1f,1f,10f,true,0);
		this.preferences[PreferenceType.MOB_HEALTH.index()] 			= new Preference(0,0,0,true,0);
		this.preferences[PreferenceType.GROUP_FREQUENCY.index()]    	= new Preference(.5f,.5f,2f,true,0);
		this.preferences[PreferenceType.WAVE_DIFFICULTY.index()]    	= new Preference(1f,1f,10f,true,0);
		this.preferences[PreferenceType.WAVE_FREQUENCY.index()] 		= new Preference(6f,1f,15f,true,0);
		this.preferences[PreferenceType.STARTING_LIVES.index()] 		= new Preference(0,0,0);
		this.preferences[PreferenceType.TURRET_COST.index()]		 	= new Preference(0,0,0);
		this.preferences[PreferenceType.MOB_VALUE.index()] 				= new Preference(0,0,0);
		this.preferences[PreferenceType.GAME_LENGTH.index()] 			= new Preference(-1,-1,18000);
		this.preferences[PreferenceType.GAME_WAVES.index()] 			= new Preference(-1,-1,100);
		this.preferences[PreferenceType.STARTING_MONEY.index()] 		= new Preference(0,0,0);
